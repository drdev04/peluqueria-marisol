<?php
	...
	header('location:logout.php');
		...
		if(isset($_POST['submit'])) {	
			...
			$query=mysqli_query($con, "update  tbcliente set Name='$name', LastName='$ape', Dni='$dni', Email='$email', MobileNumber='$mobilenum', Genero='$gender', UserName='$usu', Password='$pass' where ID='$eid' ");
			if ($query) {
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title"><h4>Actualizar Información de Cliente:</h4></div>
						<div class="form-body">
							<form method="post">
								...
								<?php
									$cid=$_GET['editid'];
									$ret=mysqli_query($con,"select * from  tbcliente where ID='$cid'");
									$cnt=1;
								...
								?> 
									...
									<div class="form-group"> 
										...
										<input type="text" class="form-control" id="apellido" name="apellido"  value="<?php  echo $row['LastName'];?>" required="true">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1" class="form-label">Dni</label>
										<input type="number" class="form-control" id="dni" name="dni" value="<?php  echo $row['Dni'];?>" required="true">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="exampleInputPassword1">Número de móvil del cliente</label> 
										<input type="text" id="mobilenum" name="mobilenum" class="form-control"  value="<?php  echo $row['MobileNumber'];?>" required="true">
									</div>
									<div class="form-group"> 
										<label for="exampleInputPassword1">Género del cliente</label>
										<?php 
											if($row['Gender']=="Male") { 
										?>
									...
									<div class="form-group">
										<label for="exampleInputPassword1">Nombre de usuario del cliente</label> 
										<input type="text" id="usuario" name="usuario" class="form-control"  value="<?php  echo $row['UserName'];?>" required="true">
									</div>
									<div class="form-group">
										<label for="exampleInputPassword1">Contraseña del cliente</label> 
										<input type="text" id="contrasena" name="contrasena" class="form-control"  value="<?php  echo $row['Password'];?>" required="true">
									</div>
									<div class="form-group">
								...
								?>
								<button type="submit" name="submit" class="btn btn-default">Actualizar información del cliente</button>
							</form> 
						</div>						
					</div>					
				</div>
