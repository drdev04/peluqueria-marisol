<?php
	...
	if (strlen($_SESSION['bpmsaid']==0)) {
		...
		if(isset($_POST['submit'])) {
    		...
    		$query=mysqli_query($con, "insert into tblservices(ServiceName,Cost,img) value ('$sername','$cost','$url')");
    		if ($query) {
							...
							<form method="post">
								<p style="font-size:16px; color:red" align="center"> 
							 	...
							 	<div class="form-group"> 
									...
									<input type="text" class="form-control" id="sername" name="sername" placeholder="Nombre de Servicio" value="" required="true"> 
								</div> 
								<div class="form-group"> 
									<label for="exampleInputPassword1">Costo</label>
									<input type="number" id="cost" name="cost" class="form-control" placeholder="Costo" value="" required="true">
								</div>	
								<div class="form-group"> 
